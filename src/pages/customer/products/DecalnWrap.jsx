    ...
    return (
        ...
        `}>
            ...
            <div className="w-full lg:w-[48%] self-stretch relative overflow-hidden bg-gray-50 flex-shrink-0">
                ...
                />
                {/* Gradient overlay on hover edge */}
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-8 py-12 px-10">
                ...
                {item.product_description && (
                    <p className="self-start text-gray-500 text-sm font-medium leading-relaxed max-w-md">
                        {item.product_description}
                    </p>
                )}
    ...
    >
        ...
        <div className="px-8 pt-6 pb-8 flex flex-col flex-1">
            ...
            <div className="space-y-1 flex-1">
                ...
                {bike.product_description && (
                    <p className="text-gray-500 text-xs mt-4 line-clamp-3 leading-relaxed">
                        {bike.product_description}
                    </p>
                )}
            </div>
...
const DecalnWrap = () => {
    ...
    useEffect(() => {
        const id = setInterval(() => refreshProducts(), 60000);
    ...
    if (loading) {
        return (
            <CustDBProductsLayout categoryName="Decal">
